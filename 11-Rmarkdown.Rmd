...
![](images/rmarkdown/how-1-file.png)
...
![코드청크 옵션 예시](images/rmarkdown/codechunk1.PNG){width=300}
...
```{r, fig.align="center", fig.width=6, fig.height=6, fig.cap="자동차 모델에 따른 고속도로 연비 분포", eval=F}
...
![자동차 모델에 따른 고속도로 연비 분포](images/rmarkdown/000002.PNG){width=500}
